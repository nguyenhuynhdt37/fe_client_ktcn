  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <button
        ...
        className="relative group w-14 h-14 rounded-full bg-gradient-to-tr from-brand-darkred to-red-600 text-white flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-105 hover:shadow-brand-darkred/20 active:scale-95 transition-all duration-300 cursor-pointer overflow-hidden"
      >
