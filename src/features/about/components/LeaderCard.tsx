...
export function LeaderCard({ leader, locale }: LeaderCardProps) {
  ...
  return (
    <div className="border border-border rounded-xl bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between">
      {/* Portrait Photo */}
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-1.5 text-center">
          <p className="text-[11px] text-brand-darkred font-extrabold uppercase tracking-wider">
            {positionName}
          </p>
